(function ($) {
    ...
    $(function () {
        ...
        if ($("#doughnutChart1").length) {
            ...
            var trafficChartCanvas = $("#doughnutChart1")
                .get(0)
                .getContext("2d");
        ...
        if ($("#doughnutChart2").length) {
            ...
            var trafficChartData = {
                datasets: [
                    {
                        data: [40, 20, 40],
                        backgroundColor: [blue1, green1, red1],
                        hoverBackgroundColor: [blue1, green1, red1],
                        borderColor: [blue1, green1, red1],
                        legendColor: [blue1, green1, red1],
                    },
                ],
            ...
            var trafficChartCanvas = $("#doughnutChart2")
                .get(0)
                .getContext("2d");
            var trafficChart = new Chart(trafficChartCanvas, {
                type: "doughnut",
        ...
        if ($("#doughnutChart3").length) {
            ...
            var trafficChartCanvas = $("#doughnutChart3")
                .get(0)
                .getContext("2d");
            var trafficChart = new Chart(trafficChartCanvas, {
                type: "doughnut",
    ...
    if ($("#deseaseReport").length) {
            ...
            datasets: [
                {
                    ...
                    borderColor: ["#00cff4", "#5e6eed", "#ff0d59", "#00d284"],
                    legendColor: ["#00cff4", "#5e6eed", "#ff0d59", "#00d284"],
                },
            ],

            // These labels appear in the legend and in the tooltips when hovering different arcs
            labels: ["Pneumonia", "Daibetis", "Colds", "Flue"],
        };
        var deseaseReportOptions = {
            ...
            legendCallback: function (chart) {
                ...
                for (
                    var i = 0;
                    i < deseaseReportData.datasets[0].data.length;
                    i++
                ) {
                    text.push(
                        '<li><div><span class="legend-dots" style="background:' +
    ...
    if ($("#employeeDepartment").length) {
        ...
        var employeeDepartmentData = {
            ...
            // These labels appear in the legend and in the tooltips when hovering different arcs
            labels: ["Developer", "Designer", "Sales", "Tester"],
        };
        var employeeDepartmentOptions = {
            ...
            legendCallback: function (chart) {
                ...
                for (
                    var i = 0;
                    i < employeeDepartmentData.datasets[0].data.length;
                    i++
                ) {
                    text.push(
                        '<li class="mb-1"><div><span class="legend-dots" style="background:' +
        ...
        var employeeDepartmentCanvas = $("#employeeDepartment")
            .get(0)
            .getContext("2d");
        ...
        $("#employeeDepartment-legend3").html(
            employeeDepartment.generateLegend()
        );
    }
    var totalSalaryData = {
